...
**시뮬레이션 실행 시간**: 2025년 08월 06일 05시 09분 08초
...
=== 냉장고 1 제조 시작 ===
[시간 0.0] 공정 체인 실행 시작 (체인 ID: 62bfa155-1a1e-434b-a73e-9eb792c3e3ac)
총 5개의 공정을 순차 실행합니다.
...
[시간 0.0] 다중공정 그룹 실행 시작 (그룹 ID: ec6ef67b-b4f8-4c30-b526-30a355d905ae)
...
[시간 0.0] 다중공정 그룹 실행 시작 (그룹 ID: b7cfc508-b9f7-46fa-8367-3b6f7db0984f)
...
[시간 1.0] ResourceManager: 운송 완료 이벤트 생성 (할당 ID: transport_GASKET_MOLDING_PROC_1.0_9d865b7e)
[시간 1.0] 가스켓 성형 Transport 요청 접수됨 - 완료까지 대기
[시간 1.0] 가스켓 성형 출력 버퍼에서 제품 제거 (운송 요청 접수 완료, 남은 개수: 0)
[시간 1.0] ResourceManager: GASKET_MOLDING_PROC 운송 요청 처리 시작 (할당 ID: transport_GASKET_MOLDING_PROC_1.0_9d865b7e)
[시간 1.0] Transport 할당 완료: transport_001 to GASKET_MOLDING_PROC (할당 ID: 25d91034-a4f6-4030-a739-74adaf6e98dc, 대기시간: 0.0)
[시간 1.0] ResourceManager: GASKET_MOLDING_PROC 운송 할당 성공 (할당 ID: 25d91034-a4f6-4030-a739-74adaf6e98dc)
...
[시간 1.5] 가스켓 성형 Transport 완료 알림 수신: {'allocation_id': 'transport_GASKET_MOLDING_PROC_1.0_9d865b7e', 'requester_id': 'GASKET_MOLDING_PROC', 'success': True, 'completion_time': 1.5}
...
[시간 3.0] ResourceManager: 운송 완료 이벤트 생성 (할당 ID: transport_HANDLE_ASSEMBLY_PROC_3.0_0c504582)
[시간 3.0] 핸들 조립 Transport 요청 접수됨 - 완료까지 대기
[시간 3.0] 핸들 조립 출력 버퍼에서 제품 제거 (운송 요청 접수 완료, 남은 개수: 0)
[시간 3.0] ResourceManager: HANDLE_ASSEMBLY_PROC 운송 요청 처리 시작 (할당 ID: transport_HANDLE_ASSEMBLY_PROC_3.0_0c504582)
[시간 3.0] Transport 할당 완료: transport_001 to HANDLE_ASSEMBLY_PROC (할당 ID: 10e82b41-8074-42f5-8d96-b27d29a0a14b, 대기시간: 0.0)
[시간 3.0] ResourceManager: HANDLE_ASSEMBLY_PROC 운송 할당 성공 (할당 ID: 10e82b41-8074-42f5-8d96-b27d29a0a14b)
...
[시간 3.5] 핸들 조립 Transport 완료 알림 수신: {'allocation_id': 'transport_HANDLE_ASSEMBLY_PROC_3.0_0c504582', 'requester_id': 'HANDLE_ASSEMBLY_PROC', 'success': True, 'completion_time': 3.5}
[시간 3.5] 핸들 조립 Transport 성공적으로 완료
  [시간 3.5] [OK] 핸들 조립 완료
[시간 3.5] 다중공정 그룹 실행 완료 (그룹 ID: b7cfc508-b9f7-46fa-8367-3b6f7db0984f)
  [시간 3.5] [OK] [컴프레서 테스트 & 가스켓 성형 & 핸들 조립] 완료
  [시간 3.5] [2/3] 그룹래퍼([도어패널 제조 & 도어프레임 제조]) → 도어패널 운송 → 도어프레임 운송 → 도어 어셈블리 실행 중...
[시간 3.5] 공정 체인 실행 시작 (체인 ID: 09781b1b-5ffa-498e-a2aa-32cec7e519d5)
총 4개의 공정을 순차 실행합니다.

[시간 3.5] [1/4] 그룹래퍼([도어패널 제조 & 도어프레임 제조]) 실행 중...
[시간 3.5] 그룹래퍼([도어패널 제조 & 도어프레임 제조]) 실행 시작
[시간 3.5] 다중공정 그룹 실행 시작 (그룹 ID: 253ac39e-952e-4a3b-8c5d-c53f46e82f81)
...
[시간 5.5] ResourceManager: 운송 완료 이벤트 생성 (할당 ID: transport_DOOR_PANEL_PROC_5.5_db7eb419)
[시간 5.5] 도어패널 제조 Transport 요청 접수됨 - 완료까지 대기
[시간 5.5] 도어패널 제조 출력 버퍼에서 제품 제거 (운송 요청 접수 완료, 남은 개수: 0)
[시간 5.5] ResourceManager: DOOR_PANEL_PROC 운송 요청 처리 시작 (할당 ID: transport_DOOR_PANEL_PROC_5.5_db7eb419)
[시간 5.5] 도어패널 운송 대기 중... (소요시간: 0.3)
[시간 5.5] Transport 할당 완료: transport_001 to DOOR_PANEL_PROC (할당 ID: dddbe1f9-61d1-450b-b755-7027e66baf9b, 대기시간: 0.0)
[시간 5.5] ResourceManager: DOOR_PANEL_PROC 운송 할당 성공 (할당 ID: dddbe1f9-61d1-450b-b755-7027e66baf9b)
...
[시간 6.0] 도어패널 제조 Transport 완료 알림 수신: {'allocation_id': 'transport_DOOR_PANEL_PROC_5.5_db7eb419', 'requester_id': 'DOOR_PANEL_PROC', 'success': True, 'completion_time': 6.0}
...
[시간 8.5] ResourceManager: 운송 완료 이벤트 생성 (할당 ID: transport_DOOR_FRAME_PROC_8.5_41d5f31f)
[시간 8.5] 도어프레임 제조 Transport 요청 접수됨 - 완료까지 대기
[시간 8.5] 도어프레임 제조 출력 버퍼에서 제품 제거 (운송 요청 접수 완료, 남은 개수: 0)
[시간 8.5] ResourceManager: DOOR_FRAME_PROC 운송 요청 처리 시작 (할당 ID: transport_DOOR_FRAME_PROC_8.5_41d5f31f)
[시간 8.5] Transport 할당 완료: transport_001 to DOOR_FRAME_PROC (할당 ID: b4ca839a-5c3f-4fe4-984a-bd86f5f701e0, 대기시간: 0.0)
[시간 8.5] ResourceManager: DOOR_FRAME_PROC 운송 할당 성공 (할당 ID: b4ca839a-5c3f-4fe4-984a-bd86f5f701e0)
...
[시간 9.0] 도어프레임 제조 Transport 완료 알림 수신: {'allocation_id': 'transport_DOOR_FRAME_PROC_8.5_41d5f31f', 'requester_id': 'DOOR_FRAME_PROC', 'success': True, 'completion_time': 9.0}
[시간 9.0] 도어프레임 제조 Transport 성공적으로 완료
  [시간 9.0] [OK] 도어프레임 제조 완료
[시간 9.0] 다중공정 그룹 실행 완료 (그룹 ID: 253ac39e-952e-4a3b-8c5d-c53f46e82f81)
...
[시간 16.6] ResourceManager: 운송 완료 이벤트 생성 (할당 ID: transport_DOOR_ASSEMBLY_PROC_16.6_66927656)
[시간 16.6] 도어 어셈블리 Transport 요청 접수됨 - 완료까지 대기
[시간 16.6] ResourceManager: DOOR_ASSEMBLY_PROC 운송 요청 처리 시작 (할당 ID: transport_DOOR_ASSEMBLY_PROC_16.6_66927656)
[시간 16.6] Transport 할당 완료: transport_001 to DOOR_ASSEMBLY_PROC (할당 ID: fb907931-3304-46f5-8cee-d17180ebe9b5, 대기시간: 0.0)
[시간 16.6] ResourceManager: DOOR_ASSEMBLY_PROC 운송 할당 성공 (할당 ID: fb907931-3304-46f5-8cee-d17180ebe9b5)
...
[시간 17.1] 도어 어셈블리 Transport 완료 알림 수신: {'allocation_id': 'transport_DOOR_ASSEMBLY_PROC_16.6_66927656', 'requester_id': 'DOOR_ASSEMBLY_PROC', 'success': True, 'completion_time': 17.1}
[시간 17.1] 도어 어셈블리 Transport 성공적으로 완료
[시간 17.1] [4/4] 도어 어셈블리 완료

[시간 17.1] 공정 체인 실행 완료 (체인 ID: 09781b1b-5ffa-498e-a2aa-32cec7e519d5)
...
[시간 17.1] 공정 체인 실행 시작 (체인 ID: ca5278f0-f4bc-470e-a607-4bbbb8c7bdc3)
총 4개의 공정을 순차 실행합니다.

[시간 17.1] [1/4] 그룹래퍼([본체패널 제조 & 본체프레임 제조]) 실행 중...
[시간 17.1] 그룹래퍼([본체패널 제조 & 본체프레임 제조]) 실행 시작
[시간 17.1] 다중공정 그룹 실행 시작 (그룹 ID: b45ac7dd-afe5-47a9-9341-341163463ed7)
...
[시간 17.1] 다중공정 그룹 실행 완료 (그룹 ID: b45ac7dd-afe5-47a9-9341-341163463ed7)
...
[시간 26.5] ResourceManager: 운송 완료 이벤트 생성 (할당 ID: transport_BODY_ASSEMBLY_PROC_26.5_09b45eea)
[시간 26.5] 본체 어셈블리 Transport 요청 접수됨 - 완료까지 대기
[시간 26.5] ResourceManager: BODY_ASSEMBLY_PROC 운송 요청 처리 시작 (할당 ID: transport_BODY_ASSEMBLY_PROC_26.5_09b45eea)
[시간 26.5] Transport 할당 완료: transport_001 to BODY_ASSEMBLY_PROC (할당 ID: 36d891dd-fbcb-432f-ba3c-bf19064ab21a, 대기시간: 0.0)
[시간 26.5] ResourceManager: BODY_ASSEMBLY_PROC 운송 할당 성공 (할당 ID: 36d891dd-fbcb-432f-ba3c-bf19064ab21a)
...
[시간 27.0] 본체 어셈블리 Transport 완료 알림 수신: {'allocation_id': 'transport_BODY_ASSEMBLY_PROC_26.5_09b45eea', 'requester_id': 'BODY_ASSEMBLY_PROC', 'success': True, 'completion_time': 27.0}
[시간 27.0] 본체 어셈블리 Transport 성공적으로 완료
[시간 27.0] [4/4] 본체 어셈블리 완료

[시간 27.0] 공정 체인 실행 완료 (체인 ID: ca5278f0-f4bc-470e-a607-4bbbb8c7bdc3)
  [시간 27.0] [OK] 그룹래퍼([본체패널 제조 & 본체프레임 제조]) → 본체패널 운송 → 본체프레임 운송 → 본체 어셈블리 완료
[시간 27.0] 다중공정 그룹 실행 완료 (그룹 ID: ec6ef67b-b4f8-4c30-b526-30a355d905ae)
...
[시간 36.0] ResourceManager: 운송 완료 이벤트 생성 (할당 ID: transport_REFRIGERATOR_ASSEMBLY_PROC_36.0_452695bc)
[시간 36.0] 냉장고 조립 Transport 요청 접수됨 - 완료까지 대기
[시간 36.0] ResourceManager: REFRIGERATOR_ASSEMBLY_PROC 운송 요청 처리 시작 (할당 ID: transport_REFRIGERATOR_ASSEMBLY_PROC_36.0_452695bc)
[시간 36.0] Transport 할당 완료: transport_001 to REFRIGERATOR_ASSEMBLY_PROC (할당 ID: db6ff9f0-fbc0-431e-8f74-e0a711ae5045, 대기시간: 0.0)
[시간 36.0] ResourceManager: REFRIGERATOR_ASSEMBLY_PROC 운송 할당 성공 (할당 ID: db6ff9f0-fbc0-431e-8f74-e0a711ae5045)
...
[시간 36.5] 냉장고 조립 Transport 완료 알림 수신: {'allocation_id': 'transport_REFRIGERATOR_ASSEMBLY_PROC_36.0_452695bc', 'requester_id': 'REFRIGERATOR_ASSEMBLY_PROC', 'success': True, 'completion_time': 36.5}
...
=== 냉장고 2 제조 시작 ===
[시간 41.5] 공정 체인 실행 시작 (체인 ID: 62bfa155-1a1e-434b-a73e-9eb792c3e3ac)
총 5개의 공정을 순차 실행합니다.
...
[시간 41.5] 다중공정 그룹 실행 시작 (그룹 ID: ec6ef67b-b4f8-4c30-b526-30a355d905ae)
순차 실행할 공정: [컴프레서 테스트 & 가스켓 성형 & 핸들 조립], 그룹래퍼([도어패널 제조 & 도어프레임 제조]) → 도어패널 운송 → 도어프레임 운송 → 도어 어셈블리, 그룹래퍼([본체패널 제조 & 본체프레임 제조]) → 본체패널 운송 → 본체프레임 운송 → 본체 어셈블리
  [시간 41.5] [1/3] [컴프레서 테스트 & 가스켓 성형 & 핸들 조립] 실행 중...
[시간 41.5] 다중공정 그룹 실행 시작 (그룹 ID: b7cfc508-b9f7-46fa-8367-3b6f7db0984f)
순차 실행할 공정: 컴프레서 테스트, 가스켓 성형, 핸들 조립
...
[시간 42.5] ResourceManager: 운송 완료 이벤트 생성 (할당 ID: transport_GASKET_MOLDING_PROC_42.5_0edca6a1)
[시간 42.5] 가스켓 성형 Transport 요청 접수됨 - 완료까지 대기
[시간 42.5] 가스켓 성형 출력 버퍼에서 제품 제거 (운송 요청 접수 완료, 남은 개수: 0)
[시간 42.5] ResourceManager: GASKET_MOLDING_PROC 운송 요청 처리 시작 (할당 ID: transport_GASKET_MOLDING_PROC_42.5_0edca6a1)
[시간 42.5] Transport 할당 완료: transport_001 to GASKET_MOLDING_PROC (할당 ID: e423bc69-b385-42fc-85d4-384bc0ae4e00, 대기시간: 0.0)
[시간 42.5] ResourceManager: GASKET_MOLDING_PROC 운송 할당 성공 (할당 ID: e423bc69-b385-42fc-85d4-384bc0ae4e00)
...
[시간 43.0] 가스켓 성형 Transport 완료 알림 수신: {'allocation_id': 'transport_GASKET_MOLDING_PROC_42.5_0edca6a1', 'requester_id': 'GASKET_MOLDING_PROC', 'success': True, 'completion_time': 43.0}
...
[시간 44.5] ResourceManager: 운송 완료 이벤트 생성 (할당 ID: transport_HANDLE_ASSEMBLY_PROC_44.5_b087cc25)
[시간 44.5] 핸들 조립 Transport 요청 접수됨 - 완료까지 대기
[시간 44.5] 핸들 조립 출력 버퍼에서 제품 제거 (운송 요청 접수 완료, 남은 개수: 0)
[시간 44.5] ResourceManager: HANDLE_ASSEMBLY_PROC 운송 요청 처리 시작 (할당 ID: transport_HANDLE_ASSEMBLY_PROC_44.5_b087cc25)
[시간 44.5] Transport 할당 완료: transport_001 to HANDLE_ASSEMBLY_PROC (할당 ID: e8882bff-dff7-4087-b1ea-568e77dc16d9, 대기시간: 0.0)
[시간 44.5] ResourceManager: HANDLE_ASSEMBLY_PROC 운송 할당 성공 (할당 ID: e8882bff-dff7-4087-b1ea-568e77dc16d9)
...
[시간 45.0] 핸들 조립 Transport 완료 알림 수신: {'allocation_id': 'transport_HANDLE_ASSEMBLY_PROC_44.5_b087cc25', 'requester_id': 'HANDLE_ASSEMBLY_PROC', 'success': True, 'completion_time': 45.0}
[시간 45.0] 핸들 조립 Transport 성공적으로 완료
  [시간 45.0] [OK] 핸들 조립 완료
[시간 45.0] 다중공정 그룹 실행 완료 (그룹 ID: b7cfc508-b9f7-46fa-8367-3b6f7db0984f)
  [시간 45.0] [OK] [컴프레서 테스트 & 가스켓 성형 & 핸들 조립] 완료
  [시간 45.0] [2/3] 그룹래퍼([도어패널 제조 & 도어프레임 제조]) → 도어패널 운송 → 도어프레임 운송 → 도어 어셈블리 실행 중...
[시간 45.0] 공정 체인 실행 시작 (체인 ID: 09781b1b-5ffa-498e-a2aa-32cec7e519d5)
총 4개의 공정을 순차 실행합니다.

[시간 45.0] [1/4] 그룹래퍼([도어패널 제조 & 도어프레임 제조]) 실행 중...
[시간 45.0] 그룹래퍼([도어패널 제조 & 도어프레임 제조]) 실행 시작
[시간 45.0] 다중공정 그룹 실행 시작 (그룹 ID: 253ac39e-952e-4a3b-8c5d-c53f46e82f81)
순차 실행할 공정: 도어패널 제조, 도어프레임 제조
...
[시간 47.0] ResourceManager: 운송 완료 이벤트 생성 (할당 ID: transport_DOOR_PANEL_PROC_47.0_fabf3bcc)
[시간 47.0] 도어패널 제조 Transport 요청 접수됨 - 완료까지 대기
[시간 47.0] 도어패널 제조 출력 버퍼에서 제품 제거 (운송 요청 접수 완료, 남은 개수: 0)
[시간 47.0] ResourceManager: DOOR_PANEL_PROC 운송 요청 처리 시작 (할당 ID: transport_DOOR_PANEL_PROC_47.0_fabf3bcc)
[시간 47.0] 도어패널 운송 대기 중... (소요시간: 0.3)
[시간 47.0] Transport 할당 완료: transport_001 to DOOR_PANEL_PROC (할당 ID: 211ce9a5-2852-4db0-92c3-d80d2b04081d, 대기시간: 0.0)
[시간 47.0] ResourceManager: DOOR_PANEL_PROC 운송 할당 성공 (할당 ID: 211ce9a5-2852-4db0-92c3-d80d2b04081d)
...
[시간 47.5] 도어패널 제조 Transport 완료 알림 수신: {'allocation_id': 'transport_DOOR_PANEL_PROC_47.0_fabf3bcc', 'requester_id': 'DOOR_PANEL_PROC', 'success': True, 'completion_time': 47.5}
...
[시간 50.0] ResourceManager: 운송 완료 이벤트 생성 (할당 ID: transport_DOOR_FRAME_PROC_50.0_ae5bce0b)
[시간 50.0] 도어프레임 제조 Transport 요청 접수됨 - 완료까지 대기
[시간 50.0] 도어프레임 제조 출력 버퍼에서 제품 제거 (운송 요청 접수 완료, 남은 개수: 0)
[시간 50.0] ResourceManager: DOOR_FRAME_PROC 운송 요청 처리 시작 (할당 ID: transport_DOOR_FRAME_PROC_50.0_ae5bce0b)
[시간 50.0] Transport 할당 완료: transport_001 to DOOR_FRAME_PROC (할당 ID: dbc527d0-666a-4e71-a5c5-81787869e6f7, 대기시간: 0.0)
[시간 50.0] ResourceManager: DOOR_FRAME_PROC 운송 할당 성공 (할당 ID: dbc527d0-666a-4e71-a5c5-81787869e6f7)
...
[시간 50.5] 도어프레임 제조 Transport 완료 알림 수신: {'allocation_id': 'transport_DOOR_FRAME_PROC_50.0_ae5bce0b', 'requester_id': 'DOOR_FRAME_PROC', 'success': True, 'completion_time': 50.5}
[시간 50.5] 도어프레임 제조 Transport 성공적으로 완료
  [시간 50.5] [OK] 도어프레임 제조 완료
[시간 50.5] 다중공정 그룹 실행 완료 (그룹 ID: 253ac39e-952e-4a3b-8c5d-c53f46e82f81)
...
[시간 58.1] ResourceManager: 운송 완료 이벤트 생성 (할당 ID: transport_DOOR_ASSEMBLY_PROC_58.099999999999994_15ecfd5a)
[시간 58.1] 도어 어셈블리 Transport 요청 접수됨 - 완료까지 대기
[시간 58.1] ResourceManager: DOOR_ASSEMBLY_PROC 운송 요청 처리 시작 (할당 ID: transport_DOOR_ASSEMBLY_PROC_58.099999999999994_15ecfd5a)
[시간 58.1] Transport 할당 완료: transport_001 to DOOR_ASSEMBLY_PROC (할당 ID: c902d5dc-faf6-4b03-b898-050d535184b5, 대기시간: 0.0)
[시간 58.1] ResourceManager: DOOR_ASSEMBLY_PROC 운송 할당 성공 (할당 ID: c902d5dc-faf6-4b03-b898-050d535184b5)
...
[시간 58.6] 도어 어셈블리 Transport 완료 알림 수신: {'allocation_id': 'transport_DOOR_ASSEMBLY_PROC_58.099999999999994_15ecfd5a', 'requester_id': 'DOOR_ASSEMBLY_PROC', 'success': True, 'completion_time': 58.599999999999994}
[시간 58.6] 도어 어셈블리 Transport 성공적으로 완료
[시간 58.6] [4/4] 도어 어셈블리 완료

[시간 58.6] 공정 체인 실행 완료 (체인 ID: 09781b1b-5ffa-498e-a2aa-32cec7e519d5)
...
[시간 58.6] 공정 체인 실행 시작 (체인 ID: ca5278f0-f4bc-470e-a607-4bbbb8c7bdc3)
총 4개의 공정을 순차 실행합니다.

[시간 58.6] [1/4] 그룹래퍼([본체패널 제조 & 본체프레임 제조]) 실행 중...
[시간 58.6] 그룹래퍼([본체패널 제조 & 본체프레임 제조]) 실행 시작
[시간 58.6] 다중공정 그룹 실행 시작 (그룹 ID: b45ac7dd-afe5-47a9-9341-341163463ed7)
순차 실행할 공정: 본체패널 제조, 본체프레임 제조
...
[시간 58.6] 다중공정 그룹 실행 완료 (그룹 ID: b45ac7dd-afe5-47a9-9341-341163463ed7)
...
[시간 68.0] ResourceManager: 운송 완료 이벤트 생성 (할당 ID: transport_BODY_ASSEMBLY_PROC_68.0_31572489)
[시간 68.0] 본체 어셈블리 Transport 요청 접수됨 - 완료까지 대기
[시간 68.0] ResourceManager: BODY_ASSEMBLY_PROC 운송 요청 처리 시작 (할당 ID: transport_BODY_ASSEMBLY_PROC_68.0_31572489)
[시간 68.0] Transport 할당 완료: transport_001 to BODY_ASSEMBLY_PROC (할당 ID: 694621c6-0c93-42b2-82a3-322169cd1098, 대기시간: 0.0)
[시간 68.0] ResourceManager: BODY_ASSEMBLY_PROC 운송 할당 성공 (할당 ID: 694621c6-0c93-42b2-82a3-322169cd1098)
...
[시간 68.5] 본체 어셈블리 Transport 완료 알림 수신: {'allocation_id': 'transport_BODY_ASSEMBLY_PROC_68.0_31572489', 'requester_id': 'BODY_ASSEMBLY_PROC', 'success': True, 'completion_time': 68.5}
[시간 68.5] 본체 어셈블리 Transport 성공적으로 완료
[시간 68.5] [4/4] 본체 어셈블리 완료

[시간 68.5] 공정 체인 실행 완료 (체인 ID: ca5278f0-f4bc-470e-a607-4bbbb8c7bdc3)
  [시간 68.5] [OK] 그룹래퍼([본체패널 제조 & 본체프레임 제조]) → 본체패널 운송 → 본체프레임 운송 → 본체 어셈블리 완료
[시간 68.5] 다중공정 그룹 실행 완료 (그룹 ID: ec6ef67b-b4f8-4c30-b526-30a355d905ae)
...
[시간 77.5] ResourceManager: 운송 완료 이벤트 생성 (할당 ID: transport_REFRIGERATOR_ASSEMBLY_PROC_77.5_53349cc4)
[시간 77.5] 냉장고 조립 Transport 요청 접수됨 - 완료까지 대기
[시간 77.5] ResourceManager: REFRIGERATOR_ASSEMBLY_PROC 운송 요청 처리 시작 (할당 ID: transport_REFRIGERATOR_ASSEMBLY_PROC_77.5_53349cc4)
[시간 77.5] Transport 할당 완료: transport_001 to REFRIGERATOR_ASSEMBLY_PROC (할당 ID: 2ea4e98d-4d6a-4f5e-aebb-41d17556d012, 대기시간: 0.0)
[시간 77.5] ResourceManager: REFRIGERATOR_ASSEMBLY_PROC 운송 할당 성공 (할당 ID: 2ea4e98d-4d6a-4f5e-aebb-41d17556d012)
...
[시간 78.0] 냉장고 조립 Transport 완료 알림 수신: {'allocation_id': 'transport_REFRIGERATOR_ASSEMBLY_PROC_77.5_53349cc4', 'requester_id': 'REFRIGERATOR_ASSEMBLY_PROC', 'success': True, 'completion_time': 78.0}
...
- **파일 생성 시간**: 2025년 08월 06일 05시 09분 08초
