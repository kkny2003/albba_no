...
**시뮬레이션 실행 시간**: 2025년 08월 06일 05시 11분 16초
...
=== 냉장고 1 제조 시작 ===
[시간 0.0] 공정 체인 실행 시작 (체인 ID: 554db7e7-cf72-465d-8466-79079cedfafe)
총 5개의 공정을 순차 실행합니다.
...
[시간 0.0] 다중공정 그룹 실행 시작 (그룹 ID: 593410a0-552f-43e8-b9d5-e81820b0d503)
...
[시간 0.0] 다중공정 그룹 실행 시작 (그룹 ID: ff25fa4c-9f5f-4b74-91f1-ee63f3da94c8)
...
[시간 1.0] ResourceManager: 운송 완료 이벤트 생성 (할당 ID: transport_GASKET_MOLDING_PROC_1.0_6ac1bebf)
[시간 1.0] 가스켓 성형 Transport 요청 접수됨 - 완료까지 대기
[시간 1.0] 가스켓 성형 출력 버퍼에서 제품 제거 (운송 요청 접수 완료, 남은 개수: 0)
[시간 1.0] ResourceManager: GASKET_MOLDING_PROC 운송 요청 처리 시작 (할당 ID: transport_GASKET_MOLDING_PROC_1.0_6ac1bebf)
[시간 1.0] Transport 할당 완료: transport_001 to GASKET_MOLDING_PROC (할당 ID: ff611f20-c08b-4da5-917c-fb22e8dc60fd, 대기시간: 0.0)
[시간 1.0] ResourceManager: GASKET_MOLDING_PROC 운송 할당 성공 (할당 ID: ff611f20-c08b-4da5-917c-fb22e8dc60fd)
...
[시간 1.5] 가스켓 성형 Transport 완료 알림 수신: {'allocation_id': 'transport_GASKET_MOLDING_PROC_1.0_6ac1bebf', 'requester_id': 'GASKET_MOLDING_PROC', 'success': True, 'completion_time': 1.5}
...
[시간 3.0] ResourceManager: 운송 완료 이벤트 생성 (할당 ID: transport_HANDLE_ASSEMBLY_PROC_3.0_2ce33d72)
[시간 3.0] 핸들 조립 Transport 요청 접수됨 - 완료까지 대기
[시간 3.0] 핸들 조립 출력 버퍼에서 제품 제거 (운송 요청 접수 완료, 남은 개수: 0)
[시간 3.0] ResourceManager: HANDLE_ASSEMBLY_PROC 운송 요청 처리 시작 (할당 ID: transport_HANDLE_ASSEMBLY_PROC_3.0_2ce33d72)
[시간 3.0] Transport 할당 완료: transport_001 to HANDLE_ASSEMBLY_PROC (할당 ID: ac9e9c22-3fa5-47d3-a663-b2acad6e9a40, 대기시간: 0.0)
[시간 3.0] ResourceManager: HANDLE_ASSEMBLY_PROC 운송 할당 성공 (할당 ID: ac9e9c22-3fa5-47d3-a663-b2acad6e9a40)
...
[시간 3.5] 핸들 조립 Transport 완료 알림 수신: {'allocation_id': 'transport_HANDLE_ASSEMBLY_PROC_3.0_2ce33d72', 'requester_id': 'HANDLE_ASSEMBLY_PROC', 'success': True, 'completion_time': 3.5}
[시간 3.5] 핸들 조립 Transport 성공적으로 완료
  [시간 3.5] [OK] 핸들 조립 완료
[시간 3.5] 다중공정 그룹 실행 완료 (그룹 ID: ff25fa4c-9f5f-4b74-91f1-ee63f3da94c8)
  [시간 3.5] [OK] [컴프레서 테스트 & 가스켓 성형 & 핸들 조립] 완료
  [시간 3.5] [2/3] 그룹래퍼([도어패널 제조 & 도어프레임 제조]) → 도어패널 운송 → 도어프레임 운송 → 도어 어셈블리 실행 중...
[시간 3.5] 공정 체인 실행 시작 (체인 ID: dc7d75b9-fd86-492d-8abd-bcdd51e7ae76)
총 4개의 공정을 순차 실행합니다.

[시간 3.5] [1/4] 그룹래퍼([도어패널 제조 & 도어프레임 제조]) 실행 중...
[시간 3.5] 그룹래퍼([도어패널 제조 & 도어프레임 제조]) 실행 시작
[시간 3.5] 다중공정 그룹 실행 시작 (그룹 ID: afdbeb5b-649f-4822-ad87-6d92e7853957)
...
[시간 5.5] ResourceManager: 운송 완료 이벤트 생성 (할당 ID: transport_DOOR_PANEL_PROC_5.5_f2d8d846)
[시간 5.5] 도어패널 제조 Transport 요청 접수됨 - 완료까지 대기
[시간 5.5] 도어패널 제조 출력 버퍼에서 제품 제거 (운송 요청 접수 완료, 남은 개수: 0)
[시간 5.5] ResourceManager: DOOR_PANEL_PROC 운송 요청 처리 시작 (할당 ID: transport_DOOR_PANEL_PROC_5.5_f2d8d846)
[시간 5.5] 도어패널 운송 대기 중... (소요시간: 0.3)
[시간 5.5] Transport 할당 완료: transport_001 to DOOR_PANEL_PROC (할당 ID: f1e6b314-fad0-405f-a027-0a68b4f0dd84, 대기시간: 0.0)
[시간 5.5] ResourceManager: DOOR_PANEL_PROC 운송 할당 성공 (할당 ID: f1e6b314-fad0-405f-a027-0a68b4f0dd84)
...
[시간 6.0] 도어패널 제조 Transport 완료 알림 수신: {'allocation_id': 'transport_DOOR_PANEL_PROC_5.5_f2d8d846', 'requester_id': 'DOOR_PANEL_PROC', 'success': True, 'completion_time': 6.0}
...
[시간 8.5] ResourceManager: 운송 완료 이벤트 생성 (할당 ID: transport_DOOR_FRAME_PROC_8.5_11680a2a)
[시간 8.5] 도어프레임 제조 Transport 요청 접수됨 - 완료까지 대기
[시간 8.5] 도어프레임 제조 출력 버퍼에서 제품 제거 (운송 요청 접수 완료, 남은 개수: 0)
[시간 8.5] ResourceManager: DOOR_FRAME_PROC 운송 요청 처리 시작 (할당 ID: transport_DOOR_FRAME_PROC_8.5_11680a2a)
[시간 8.5] Transport 할당 완료: transport_001 to DOOR_FRAME_PROC (할당 ID: 9151adc8-004b-46c4-b813-a257caafe649, 대기시간: 0.0)
[시간 8.5] ResourceManager: DOOR_FRAME_PROC 운송 할당 성공 (할당 ID: 9151adc8-004b-46c4-b813-a257caafe649)
...
[시간 9.0] 도어프레임 제조 Transport 완료 알림 수신: {'allocation_id': 'transport_DOOR_FRAME_PROC_8.5_11680a2a', 'requester_id': 'DOOR_FRAME_PROC', 'success': True, 'completion_time': 9.0}
[시간 9.0] 도어프레임 제조 Transport 성공적으로 완료
  [시간 9.0] [OK] 도어프레임 제조 완료
[시간 9.0] 다중공정 그룹 실행 완료 (그룹 ID: afdbeb5b-649f-4822-ad87-6d92e7853957)
...
[시간 16.6] ResourceManager: 운송 완료 이벤트 생성 (할당 ID: transport_DOOR_ASSEMBLY_PROC_16.6_c01cc510)
[시간 16.6] 도어 어셈블리 Transport 요청 접수됨 - 완료까지 대기
[시간 16.6] ResourceManager: DOOR_ASSEMBLY_PROC 운송 요청 처리 시작 (할당 ID: transport_DOOR_ASSEMBLY_PROC_16.6_c01cc510)
[시간 16.6] Transport 할당 완료: transport_001 to DOOR_ASSEMBLY_PROC (할당 ID: 037db07e-ac7f-43aa-a448-d5035afef964, 대기시간: 0.0)
[시간 16.6] ResourceManager: DOOR_ASSEMBLY_PROC 운송 할당 성공 (할당 ID: 037db07e-ac7f-43aa-a448-d5035afef964)
...
[시간 17.1] 도어 어셈블리 Transport 완료 알림 수신: {'allocation_id': 'transport_DOOR_ASSEMBLY_PROC_16.6_c01cc510', 'requester_id': 'DOOR_ASSEMBLY_PROC', 'success': True, 'completion_time': 17.1}
[시간 17.1] 도어 어셈블리 Transport 성공적으로 완료
[시간 17.1] [4/4] 도어 어셈블리 완료

[시간 17.1] 공정 체인 실행 완료 (체인 ID: dc7d75b9-fd86-492d-8abd-bcdd51e7ae76)
...
[시간 17.1] 공정 체인 실행 시작 (체인 ID: 9a4d7a4a-1650-4b9c-90f1-452a31e62b11)
총 4개의 공정을 순차 실행합니다.

[시간 17.1] [1/4] 그룹래퍼([본체패널 제조 & 본체프레임 제조]) 실행 중...
[시간 17.1] 그룹래퍼([본체패널 제조 & 본체프레임 제조]) 실행 시작
[시간 17.1] 다중공정 그룹 실행 시작 (그룹 ID: ff17d4f9-d056-4573-8ac1-e223e498f5ae)
...
[시간 17.1] 다중공정 그룹 실행 완료 (그룹 ID: ff17d4f9-d056-4573-8ac1-e223e498f5ae)
...
[시간 26.5] ResourceManager: 운송 완료 이벤트 생성 (할당 ID: transport_BODY_ASSEMBLY_PROC_26.5_ce649a7a)
[시간 26.5] 본체 어셈블리 Transport 요청 접수됨 - 완료까지 대기
[시간 26.5] ResourceManager: BODY_ASSEMBLY_PROC 운송 요청 처리 시작 (할당 ID: transport_BODY_ASSEMBLY_PROC_26.5_ce649a7a)
[시간 26.5] Transport 할당 완료: transport_001 to BODY_ASSEMBLY_PROC (할당 ID: 07948687-8220-4cc8-99c5-4ed07485f984, 대기시간: 0.0)
[시간 26.5] ResourceManager: BODY_ASSEMBLY_PROC 운송 할당 성공 (할당 ID: 07948687-8220-4cc8-99c5-4ed07485f984)
...
[시간 27.0] 본체 어셈블리 Transport 완료 알림 수신: {'allocation_id': 'transport_BODY_ASSEMBLY_PROC_26.5_ce649a7a', 'requester_id': 'BODY_ASSEMBLY_PROC', 'success': True, 'completion_time': 27.0}
[시간 27.0] 본체 어셈블리 Transport 성공적으로 완료
[시간 27.0] [4/4] 본체 어셈블리 완료

[시간 27.0] 공정 체인 실행 완료 (체인 ID: 9a4d7a4a-1650-4b9c-90f1-452a31e62b11)
  [시간 27.0] [OK] 그룹래퍼([본체패널 제조 & 본체프레임 제조]) → 본체패널 운송 → 본체프레임 운송 → 본체 어셈블리 완료
[시간 27.0] 다중공정 그룹 실행 완료 (그룹 ID: 593410a0-552f-43e8-b9d5-e81820b0d503)
...
[시간 36.0] ResourceManager: 운송 완료 이벤트 생성 (할당 ID: transport_REFRIGERATOR_ASSEMBLY_PROC_36.0_30a1656b)
[시간 36.0] 냉장고 조립 Transport 요청 접수됨 - 완료까지 대기
[시간 36.0] ResourceManager: REFRIGERATOR_ASSEMBLY_PROC 운송 요청 처리 시작 (할당 ID: transport_REFRIGERATOR_ASSEMBLY_PROC_36.0_30a1656b)
[시간 36.0] Transport 할당 완료: transport_001 to REFRIGERATOR_ASSEMBLY_PROC (할당 ID: 7b774ae0-3549-4d19-9ac2-7aca617830ce, 대기시간: 0.0)
[시간 36.0] ResourceManager: REFRIGERATOR_ASSEMBLY_PROC 운송 할당 성공 (할당 ID: 7b774ae0-3549-4d19-9ac2-7aca617830ce)
...
[시간 36.5] 냉장고 조립 Transport 완료 알림 수신: {'allocation_id': 'transport_REFRIGERATOR_ASSEMBLY_PROC_36.0_30a1656b', 'requester_id': 'REFRIGERATOR_ASSEMBLY_PROC', 'success': True, 'completion_time': 36.5}
...
=== 냉장고 2 제조 시작 ===
[시간 41.5] 공정 체인 실행 시작 (체인 ID: 554db7e7-cf72-465d-8466-79079cedfafe)
총 5개의 공정을 순차 실행합니다.
...
[시간 41.5] 다중공정 그룹 실행 시작 (그룹 ID: 593410a0-552f-43e8-b9d5-e81820b0d503)
순차 실행할 공정: [컴프레서 테스트 & 가스켓 성형 & 핸들 조립], 그룹래퍼([도어패널 제조 & 도어프레임 제조]) → 도어패널 운송 → 도어프레임 운송 → 도어 어셈블리, 그룹래퍼([본체패널 제조 & 본체프레임 제조]) → 본체패널 운송 → 본체프레임 운송 → 본체 어셈블리
  [시간 41.5] [1/3] [컴프레서 테스트 & 가스켓 성형 & 핸들 조립] 실행 중...
[시간 41.5] 다중공정 그룹 실행 시작 (그룹 ID: ff25fa4c-9f5f-4b74-91f1-ee63f3da94c8)
순차 실행할 공정: 컴프레서 테스트, 가스켓 성형, 핸들 조립
...
[시간 42.5] ResourceManager: 운송 완료 이벤트 생성 (할당 ID: transport_GASKET_MOLDING_PROC_42.5_7e3f20ff)
[시간 42.5] 가스켓 성형 Transport 요청 접수됨 - 완료까지 대기
[시간 42.5] 가스켓 성형 출력 버퍼에서 제품 제거 (운송 요청 접수 완료, 남은 개수: 0)
[시간 42.5] ResourceManager: GASKET_MOLDING_PROC 운송 요청 처리 시작 (할당 ID: transport_GASKET_MOLDING_PROC_42.5_7e3f20ff)
[시간 42.5] Transport 할당 완료: transport_001 to GASKET_MOLDING_PROC (할당 ID: 2e4466a7-6a41-4098-8563-0ba146c47de6, 대기시간: 0.0)
[시간 42.5] ResourceManager: GASKET_MOLDING_PROC 운송 할당 성공 (할당 ID: 2e4466a7-6a41-4098-8563-0ba146c47de6)
...
[시간 43.0] 가스켓 성형 Transport 완료 알림 수신: {'allocation_id': 'transport_GASKET_MOLDING_PROC_42.5_7e3f20ff', 'requester_id': 'GASKET_MOLDING_PROC', 'success': True, 'completion_time': 43.0}
...
[시간 44.5] ResourceManager: 운송 완료 이벤트 생성 (할당 ID: transport_HANDLE_ASSEMBLY_PROC_44.5_36e99652)
[시간 44.5] 핸들 조립 Transport 요청 접수됨 - 완료까지 대기
[시간 44.5] 핸들 조립 출력 버퍼에서 제품 제거 (운송 요청 접수 완료, 남은 개수: 0)
[시간 44.5] ResourceManager: HANDLE_ASSEMBLY_PROC 운송 요청 처리 시작 (할당 ID: transport_HANDLE_ASSEMBLY_PROC_44.5_36e99652)
[시간 44.5] Transport 할당 완료: transport_001 to HANDLE_ASSEMBLY_PROC (할당 ID: 6d0a08b2-9842-4105-a735-46c9cb208239, 대기시간: 0.0)
[시간 44.5] ResourceManager: HANDLE_ASSEMBLY_PROC 운송 할당 성공 (할당 ID: 6d0a08b2-9842-4105-a735-46c9cb208239)
...
[시간 45.0] 핸들 조립 Transport 완료 알림 수신: {'allocation_id': 'transport_HANDLE_ASSEMBLY_PROC_44.5_36e99652', 'requester_id': 'HANDLE_ASSEMBLY_PROC', 'success': True, 'completion_time': 45.0}
[시간 45.0] 핸들 조립 Transport 성공적으로 완료
  [시간 45.0] [OK] 핸들 조립 완료
[시간 45.0] 다중공정 그룹 실행 완료 (그룹 ID: ff25fa4c-9f5f-4b74-91f1-ee63f3da94c8)
  [시간 45.0] [OK] [컴프레서 테스트 & 가스켓 성형 & 핸들 조립] 완료
  [시간 45.0] [2/3] 그룹래퍼([도어패널 제조 & 도어프레임 제조]) → 도어패널 운송 → 도어프레임 운송 → 도어 어셈블리 실행 중...
[시간 45.0] 공정 체인 실행 시작 (체인 ID: dc7d75b9-fd86-492d-8abd-bcdd51e7ae76)
총 4개의 공정을 순차 실행합니다.

[시간 45.0] [1/4] 그룹래퍼([도어패널 제조 & 도어프레임 제조]) 실행 중...
[시간 45.0] 그룹래퍼([도어패널 제조 & 도어프레임 제조]) 실행 시작
[시간 45.0] 다중공정 그룹 실행 시작 (그룹 ID: afdbeb5b-649f-4822-ad87-6d92e7853957)
순차 실행할 공정: 도어패널 제조, 도어프레임 제조
...
[시간 47.0] ResourceManager: 운송 완료 이벤트 생성 (할당 ID: transport_DOOR_PANEL_PROC_47.0_f010445c)
[시간 47.0] 도어패널 제조 Transport 요청 접수됨 - 완료까지 대기
[시간 47.0] 도어패널 제조 출력 버퍼에서 제품 제거 (운송 요청 접수 완료, 남은 개수: 0)
[시간 47.0] ResourceManager: DOOR_PANEL_PROC 운송 요청 처리 시작 (할당 ID: transport_DOOR_PANEL_PROC_47.0_f010445c)
[시간 47.0] 도어패널 운송 대기 중... (소요시간: 0.3)
[시간 47.0] Transport 할당 완료: transport_001 to DOOR_PANEL_PROC (할당 ID: 978d97d9-8c8e-4989-bc3a-d6ea5a004c39, 대기시간: 0.0)
[시간 47.0] ResourceManager: DOOR_PANEL_PROC 운송 할당 성공 (할당 ID: 978d97d9-8c8e-4989-bc3a-d6ea5a004c39)
...
[시간 47.5] 도어패널 제조 Transport 완료 알림 수신: {'allocation_id': 'transport_DOOR_PANEL_PROC_47.0_f010445c', 'requester_id': 'DOOR_PANEL_PROC', 'success': True, 'completion_time': 47.5}
...
[시간 50.0] ResourceManager: 운송 완료 이벤트 생성 (할당 ID: transport_DOOR_FRAME_PROC_50.0_4ab8d1d9)
[시간 50.0] 도어프레임 제조 Transport 요청 접수됨 - 완료까지 대기
[시간 50.0] 도어프레임 제조 출력 버퍼에서 제품 제거 (운송 요청 접수 완료, 남은 개수: 0)
[시간 50.0] ResourceManager: DOOR_FRAME_PROC 운송 요청 처리 시작 (할당 ID: transport_DOOR_FRAME_PROC_50.0_4ab8d1d9)
[시간 50.0] Transport 할당 완료: transport_001 to DOOR_FRAME_PROC (할당 ID: ff911420-f5c0-4abb-bf62-edd2049eace3, 대기시간: 0.0)
[시간 50.0] ResourceManager: DOOR_FRAME_PROC 운송 할당 성공 (할당 ID: ff911420-f5c0-4abb-bf62-edd2049eace3)
...
[시간 50.5] 도어프레임 제조 Transport 완료 알림 수신: {'allocation_id': 'transport_DOOR_FRAME_PROC_50.0_4ab8d1d9', 'requester_id': 'DOOR_FRAME_PROC', 'success': True, 'completion_time': 50.5}
[시간 50.5] 도어프레임 제조 Transport 성공적으로 완료
  [시간 50.5] [OK] 도어프레임 제조 완료
[시간 50.5] 다중공정 그룹 실행 완료 (그룹 ID: afdbeb5b-649f-4822-ad87-6d92e7853957)
...
[시간 58.1] ResourceManager: 운송 완료 이벤트 생성 (할당 ID: transport_DOOR_ASSEMBLY_PROC_58.099999999999994_a708abc7)
[시간 58.1] 도어 어셈블리 Transport 요청 접수됨 - 완료까지 대기
[시간 58.1] ResourceManager: DOOR_ASSEMBLY_PROC 운송 요청 처리 시작 (할당 ID: transport_DOOR_ASSEMBLY_PROC_58.099999999999994_a708abc7)
[시간 58.1] Transport 할당 완료: transport_001 to DOOR_ASSEMBLY_PROC (할당 ID: b83ecab0-c568-4f70-9035-8cac21cc5074, 대기시간: 0.0)
[시간 58.1] ResourceManager: DOOR_ASSEMBLY_PROC 운송 할당 성공 (할당 ID: b83ecab0-c568-4f70-9035-8cac21cc5074)
...
[시간 58.6] 도어 어셈블리 Transport 완료 알림 수신: {'allocation_id': 'transport_DOOR_ASSEMBLY_PROC_58.099999999999994_a708abc7', 'requester_id': 'DOOR_ASSEMBLY_PROC', 'success': True, 'completion_time': 58.599999999999994}
[시간 58.6] 도어 어셈블리 Transport 성공적으로 완료
[시간 58.6] [4/4] 도어 어셈블리 완료

[시간 58.6] 공정 체인 실행 완료 (체인 ID: dc7d75b9-fd86-492d-8abd-bcdd51e7ae76)
...
[시간 58.6] 공정 체인 실행 시작 (체인 ID: 9a4d7a4a-1650-4b9c-90f1-452a31e62b11)
총 4개의 공정을 순차 실행합니다.

[시간 58.6] [1/4] 그룹래퍼([본체패널 제조 & 본체프레임 제조]) 실행 중...
[시간 58.6] 그룹래퍼([본체패널 제조 & 본체프레임 제조]) 실행 시작
[시간 58.6] 다중공정 그룹 실행 시작 (그룹 ID: ff17d4f9-d056-4573-8ac1-e223e498f5ae)
순차 실행할 공정: 본체패널 제조, 본체프레임 제조
...
[시간 58.6] 다중공정 그룹 실행 완료 (그룹 ID: ff17d4f9-d056-4573-8ac1-e223e498f5ae)
...
[시간 68.0] ResourceManager: 운송 완료 이벤트 생성 (할당 ID: transport_BODY_ASSEMBLY_PROC_68.0_4e6a968a)
[시간 68.0] 본체 어셈블리 Transport 요청 접수됨 - 완료까지 대기
[시간 68.0] ResourceManager: BODY_ASSEMBLY_PROC 운송 요청 처리 시작 (할당 ID: transport_BODY_ASSEMBLY_PROC_68.0_4e6a968a)
[시간 68.0] Transport 할당 완료: transport_001 to BODY_ASSEMBLY_PROC (할당 ID: 0aa07797-2da5-499a-ba20-af7193f90017, 대기시간: 0.0)
[시간 68.0] ResourceManager: BODY_ASSEMBLY_PROC 운송 할당 성공 (할당 ID: 0aa07797-2da5-499a-ba20-af7193f90017)
...
[시간 68.5] 본체 어셈블리 Transport 완료 알림 수신: {'allocation_id': 'transport_BODY_ASSEMBLY_PROC_68.0_4e6a968a', 'requester_id': 'BODY_ASSEMBLY_PROC', 'success': True, 'completion_time': 68.5}
[시간 68.5] 본체 어셈블리 Transport 성공적으로 완료
[시간 68.5] [4/4] 본체 어셈블리 완료

[시간 68.5] 공정 체인 실행 완료 (체인 ID: 9a4d7a4a-1650-4b9c-90f1-452a31e62b11)
  [시간 68.5] [OK] 그룹래퍼([본체패널 제조 & 본체프레임 제조]) → 본체패널 운송 → 본체프레임 운송 → 본체 어셈블리 완료
[시간 68.5] 다중공정 그룹 실행 완료 (그룹 ID: 593410a0-552f-43e8-b9d5-e81820b0d503)
...
[시간 77.5] ResourceManager: 운송 완료 이벤트 생성 (할당 ID: transport_REFRIGERATOR_ASSEMBLY_PROC_77.5_a0de75f1)
[시간 77.5] 냉장고 조립 Transport 요청 접수됨 - 완료까지 대기
[시간 77.5] ResourceManager: REFRIGERATOR_ASSEMBLY_PROC 운송 요청 처리 시작 (할당 ID: transport_REFRIGERATOR_ASSEMBLY_PROC_77.5_a0de75f1)
[시간 77.5] Transport 할당 완료: transport_001 to REFRIGERATOR_ASSEMBLY_PROC (할당 ID: bd16063a-ebd3-4152-a22b-47224e48c859, 대기시간: 0.0)
[시간 77.5] ResourceManager: REFRIGERATOR_ASSEMBLY_PROC 운송 할당 성공 (할당 ID: bd16063a-ebd3-4152-a22b-47224e48c859)
...
[시간 78.0] 냉장고 조립 Transport 완료 알림 수신: {'allocation_id': 'transport_REFRIGERATOR_ASSEMBLY_PROC_77.5_a0de75f1', 'requester_id': 'REFRIGERATOR_ASSEMBLY_PROC', 'success': True, 'completion_time': 78.0}
...
- **파일 생성 시간**: 2025년 08월 06일 05시 11분 16초
