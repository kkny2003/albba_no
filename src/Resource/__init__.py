...
from src.Resource.machine import Machine, create_machine_resource  # 기계 모델 클래스 및 생성 함수 임포트
from src.Resource.worker import Worker, create_worker_resource     # 작업자 모델 클래스 및 생성 함수 임포트
